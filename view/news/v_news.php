              ...
              <div class="navbar yamm">
                ...
                <div id="navbar-collapse-1" class="navbar-collapse collapse">
                  <ul class="nav navbar-nav">
                    <li><a href="https://pro-theme.com/html/autozone/home.html">HOME</a></li>
                    ...
                    <li class="dropdown" ><a href="news.html">NEWS</a>
                      <ul role="menu" class="dropdown-menu">
                        <li> <a href="https://pro-theme.com/html/autozone/news-grid.html">DROPDOWN</a> </li>
                        <li> <a href="https://pro-theme.com/html/autozone/news-details.html">DROPDOWN</a> </li>
                      </ul>
                    </li>
							...
							<main class="main-content">
								...
								<article class="post post_mod-b post_mod-d clearfix">
									<div class="entry-media">
										<img class="img-responsive" src="https://pro-theme.com/html/autozone/assets/media/posts/770x380/1.jpg" width="770" height="380" alt="Foto"/>
										<a class="entry-btn btn btn-default btn-effect" href="javascript:void(0);"><span class="btn-inner">FEATURED</span></a>
									</div>
									...
									<div class="entry-main entry-main_mod-a">
										...
										<footer class="entry-footer">
											<div class="wrap-post-btn"><a class="post-btn btn-effect" href="javascript:void(0);"><span class="post-btn__inner">read more</span></a></div>
								...
								<article class="post post_mod-b post_mod-d clearfix">
									<div class="entry-media">
										<img class="img-responsive" src="https://pro-theme.com/html/autozone/assets/media/posts/770x380/2.jpg" width="770" height="380" alt="Foto"/>
										<a class="entry-btn btn btn-default btn-effect" href="javascript:void(0);"><span class="btn-inner">FEATURED</span></a>
									</div>

									<div class="entry-main entry-main_mod-a">
										<div class="entry-main__inner">
											<h3 class="entry-title"><a href="javascript:void(0);">Lorem ipsum dolor sit amet consectetur adipisicing elit</a></h3>
											<div class="entry-meta">
												<span class="entry-meta__item">By:: <a class="entry-meta__link" href="javascript:void(0);"> ALEX LEEMAN</a></span>
												<span class="entry-meta__item">COMMENTS :: <a class="entry-meta__link" href="javascript:void(0);">15</a></span>
											</div>
								...
								<article class="post post_mod-b post_mod-d clearfix">
									<div class="entry-media">
										<img class="img-responsive" src="https://pro-theme.com/html/autozone/assets/media/posts/770x380/3.jpg" width="770" height="380" alt="Foto"/>
										<a class="entry-btn btn btn-default btn-effect" href="javascript:void(0);"><span class="btn-inner">FEATURED</span></a>
									</div>
									...
									<div class="entry-main entry-main_mod-a">
										...
										<div class="decor-1"></div>
										<div class="entry-date"><span class="entry-date__inner"><span class="entry-date__number">21</span><br>SEP</span></div>
										<div class="entry-content">
											<p>Wliquam sit amet urna sed vel nullam semper aiber vestibulum fringilla orem ipsum dolor sit amet consectetur adipisicing elit sed don eiusmod tempor incididunt ut labore et dolore magna aliquaa enimd ad minim veniam quis nostrud.</p>
										</div>
										<footer class="entry-footer">
								...
								<article class="post post_mod-b clearfix">
									<div class="entry-media">
										<img class="img-responsive" src="https://pro-theme.com/html/autozone/assets/media/posts/770x380/4.jpg" width="770" height="380" alt="Foto"/>
										<a class="entry-btn btn btn-default btn-effect" href="javascript:void(0);"><span class="btn-inner">FEATURED</span></a>
									</div>
									...
									<div class="entry-main entry-main_mod-a">
										...
										<div class="decor-1"></div>
										<div class="entry-date"><span class="entry-date__inner"><span class="entry-date__number">20</span><br>SEP</span></div>
										<div class="entry-content">
											<p>Wliquam sit amet urna sed vel nullam semper aiber vestibulum fringilla orem ipsum dolor sit amet consectetur adipisicing elit sed don eiusmod tempor incididunt ut labore et dolore magna aliquaa enimd ad minim veniam quis nostrud.</p>
										</div>
										<footer class="entry-footer">
									...
									<div class="widget-content">
										<ul class="list-categories list-unstyled">
											<li class="list-categories__item">
												<a class="list-categories__link" href="javascript:void(0);">All</a>
											</li>
											<li class="list-categories__item">
												<a class="list-categories__link" href="javascript:void(0);">Latest Vehicles</a>
											</li>
											<li class="list-categories__item">
												<a class="list-categories__link" href="javascript:void(0);">Offers & Discounts</a>
											</li>
											<li class="list-categories__item">
												<a class="list-categories__link" href="javascript:void(0);">Sports Cars</a>
											</li>
											<li class="list-categories__item">
												<a class="list-categories__link" href="javascript:void(0);">Vehicles Buying Guide</a>
											</li>
											<li class="list-categories__item">
												<a class="list-categories__link" href="javascript:void(0);">Cars Brands</a>
											</li>
										</ul>
									</div>
								</section><!-- end widget -->
									...
									<div class="widget-content">
										<div class="widget-post1 clearfix">
											<div class="widget-post1__img">
												<img class="img-responsive" src="https://pro-theme.com/html/autozone/assets/media/widget-post/3.jpg" height="75" width="75" alt="foto">
											</div>
											<div class="widget-post1__inner">
												<div class="widget-post1__info">Lorem ipsum dolor sit amet adipisicing sed ipsum</div>
										...
										<div class="widget-post1 clearfix">
											<div class="widget-post1__img">
												<img class="img-responsive" src="https://pro-theme.com/html/autozone/assets/media/widget-post/1.jpg" height="75" width="75" alt="foto">
											</div>
											<div class="widget-post1__inner">
												<div class="widget-post1__info">Tempor incididunt ut labore et dolore magna aliqua</div>
												<div class="widget-post1__reviews"><i class="icon fa fa-comment"></i> :: <a href="javascript:void(0);">15</a></div>
											</div>
										</div>
										...
										<div class="widget-post1 clearfix">
											<div class="widget-post1__img">
												<img class="img-responsive" src="https://pro-theme.com/html/autozone/assets/media/widget-post/2.jpg" height="75" width="75" alt="foto">
											</div>
											<div class="widget-post1__inner">
												<div class="widget-post1__info">Enim ad minim veniam quis nostrud exercitation</div>
												<div class="widget-post1__reviews"><i class="icon fa fa-comment"></i> :: <a href="javascript:void(0);">15</a></div>
											</div>
										</div>
									</div>
								...
								<section class="widget widget-slider">
									...
									<div class="widget-content">
										<div class="widget-slider owl-carousel owl-theme owl-theme_mod-d enable-owl-carousel"
											...
											<div class="widget-slider__item"><a href="https://www.youtube.com/watch?v=neS5h_VSvb8" rel="prettyPhoto"><img class="img-responsive" src="https://pro-theme.com/html/autozone/assets/media/banners/1.jpg" height="250" width="306" alt="banner"></a></div>
											<div class="widget-slider__item"><a href="https://www.youtube.com/watch?v=neS5h_VSvb8" rel="prettyPhoto"><img class="img-responsive" src="https://pro-theme.com/html/autozone/assets/media/banners/1.jpg" height="250" width="306" alt="banner"></a></div>
											<div class="widget-slider__item"><a href="https://www.youtube.com/watch?v=neS5h_VSvb8" rel="prettyPhoto"><img class="img-responsive" src="https://pro-theme.com/html/autozone/assets/media/banners/1.jpg" height="250" width="306" alt="banner"></a></div>
											<div class="widget-slider__item"><a href="https://www.youtube.com/watch?v=neS5h_VSvb8" rel="prettyPhoto"><img class="img-responsive" src="https://pro-theme.com/html/autozone/assets/media/banners/1.jpg" height="250" width="306" alt="banner"></a></div>
										</div>
								...
								<section class="widget">
									...
									<div class="widget-content">
										<ul class="social-blog">
											<li class="social-blog__item">
												<a class="social-blog__link" href='#'>@AutoZen</a> Lorem ipsum dolor sit amet consec tetur adipisicing elit sed
												<div class="social-blog__link"><a href='#'>http://t.co/JHAhas</a></div>
											</li>
											<li class="social-blog__item">
												<a class="social-blog__link" href='#'>@AutoZen</a> Lorem ipsum dolor sit amet consec tetur adipisicing elit sed
												<div class="social-blog__link"><a href='#'>http://t.co/JHAhas</a></div>
