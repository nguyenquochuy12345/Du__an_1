...
<!-- end container --> 
                ...
                <main class="main-content">
                    <article class="car-details">
                        ...
                        <div id="slider-product" class="flexslider slider-product">
                            <ul class="slides">
                                <li>
                                    <a href="https://pro-theme.com/html/autozone/assets/media/slider_product/large/1.jpg" >
                                        <img class="img-responsive" src="https://pro-theme.com/html/autozone/assets/media/slider_product/large/1.jpg" height="430" width="770" alt="Foto">
                                    </a>
                                </li>
                                <li>
                                    <a href="https://pro-theme.com/html/autozone/assets/media/slider_product/large/1.jpg" >
                        ...
                        <div id="carousel-product" class="flexslider carousel-product">
                            <ul class="slides">
                                <li>
                                    <img src="https://pro-theme.com/html/autozone/assets/media/slider_product/small/1.jpg" height="75" width="95" alt="foto">
                                </li>
                                <li>
                                    <img src="https://pro-theme.com/html/autozone/assets/media/slider_product/small/2.jpg" height="75" width="95" alt="foto">
                                </li>
                                <li>
                                    <img src="https://pro-theme.com/html/autozone/assets/media/slider_product/small/3.jpg" height="75" width="95" alt="foto">
                                </li>
                                <li>
                                    <img src="https://pro-theme.com/html/autozone/assets/media/slider_product/small/4.jpg" height="75" width="95" alt="foto">
                                </li>
                                <li>
                                    <img src="https://pro-theme.com/html/autozone/assets/media/slider_product/small/5.jpg" height="75" width="95" alt="foto">
                                </li>
                                <li>
                                    <img src="https://pro-theme.com/html/autozone/assets/media/slider_product/small/6.jpg" height="75" width="95" alt="foto">
                                </li>
                            </ul>
                        </div>
                        ...
                        <section class="section_letter section-bg section-bg_primary">
                            <div class="letter bg-inner">
                                <div class="letter__inner">
                                    <h2 class="letter__title">Do you want some modifications or need  a custom build vehicle ?</h2>
                        ...
                        <div class="widget-content">
                            <section class="widget-post1 clearfix">
                                ...
                                <div class="widget-post1__inner">
                                    ...
                                    <div class="widget-post1__price">Price: $33,120</div>
                            ...
                            <section class="widget-post1 clearfix">
                                ...
                                <div class="widget-post1__inner">
                                    ...
                                    <div class="widget-post1__price">Price: $40,685</div>
                                    <div class="widget-post1__description">Cullam semper aibe vestibulum</div>
                                </div>
                            </section>
                        </div>
    ...
    <footer class="footer">
        ...
        <div class="copyright">Copyrights 2015 <a class="copyright__link" href="#">AutoZONE</a> : : All rights reserved</div>
    </footer>
