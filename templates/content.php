<section class="section_mod-a section-bg-2">
          ...
          <div class="col-xs-12">
            ...
            <div class="wrap-link-img">
              <ul class="link-img link-img_mod-a list-inline wow bounceInLeft" data-wow-duration="2s">
                <li class="link-img__item"> <a class="link-img__link" href="javascript:void(0);"><img class="img-responsive" src="https://pro-theme.com/html/autozone/assets/media/link-img/1.png" height="250" width="170" alt="Foto">
                  <div class="link-img__wrap-title"><span class="link-img__title">all brands</span></div>
                  </a> </li>
                <li class="link-img__item"> <a class="link-img__link" href="javascript:void(0);"><img class="img-responsive" src="https://pro-theme.com/html/autozone/assets/media/link-img/2.png" height="250" width="170" alt="Foto">
              ...
              <ul class="link-img link-img_mod-b list-inline wow bounceInRight" data-wow-duration="2s">
                <li class="link-img__item"> <a class="link-img__link" href="javascript:void(0);"><img class="img-responsive" src="https://pro-theme.com/html/autozone/assets/media/link-img/3.png" height="250" width="170" alt="Foto">
                  <div class="link-img__wrap-title"><span class="link-img__title">DEALERSHIP</span></div>
                  </a> </li>
                <li class="link-img__item"> <a class="link-img__link" href="javascript:void(0);"><img class="img-responsive" src="https://pro-theme.com/html/autozone/assets/media/link-img/4.png" height="250" width="170" alt="Foto">
        ...
        <div class="col-xs-12">
          ...
          <div class="slider-grid owl-carousel owl-theme owl-theme_mod-c enable-owl-carousel"
            ...
            <div class="slider-grid__item">
              <div class="row">
                <div class="col-md-5">
                  <div class="slider-grid__inner slider-grid__inner_mod-a"> <img class="img-responsive" src="https://pro-theme.com/html/autozone/assets/media/slider-grid/5.jpg" height="392" width="470" alt="foto"> <a class="slider-grid__btn btn btn-default btn-effect" href="javascript:void(0);"><span class="btn-inner">FEATURED</span></a>
                    <div class="slider-grid__wrap-name"> <span class="slider-grid__name">BMW 1 Series M Coupe</span> <span class="slider-grid__price">$28,490</span> </div>
                  </div>
                </div>
                <div class="col-md-7">
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="slider-grid__inner slider-grid__inner_mod-b"> <img class="img-responsive" src="https://pro-theme.com/html/autozone/assets/media/slider-grid/1.jpg" height="181" width="320" alt="foto"> <span class="slider-grid__name">McLaren 650S</span>
                        <div class="slider-grid__hover"> <span class="slider-grid__price">$28,490</span>
                    ...
                    <div class="col-sm-6">
                      <div class="slider-grid__inner slider-grid__inner_mod-b"> <img class="img-responsive" src="https://pro-theme.com/html/autozone/assets/media/slider-grid/2.jpg" height="181" width="320" alt="foto"> <span class="slider-grid__name">Jaguar XE 2016</span>
                        <div class="slider-grid__hover"> <span class="slider-grid__price">$28,490</span>
                          <ul class="slider-grid__info list-unstyled">
                            <li><i class="icon icon-speedometer"></i>12,000</li>
                            <li><i class="icon icon-paper-plane"></i>2016</li>
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="slider-grid__inner slider-grid__inner_mod-b"> <img class="img-responsive" src="https://pro-theme.com/html/autozone/assets/media/slider-grid/3.jpg" height="181" width="320" alt="foto"> <span class="slider-grid__name">Mercedes Benz C Class</span>
                        <div class="slider-grid__hover"> <span class="slider-grid__price">$28,490</span>
                          <ul class="slider-grid__info list-unstyled">
                            <li><i class="icon icon-speedometer"></i>12,000</li>
                            <li><i class="icon icon-paper-plane"></i>2016</li>
                    ...
                    <div class="col-sm-6">
                      <div class="slider-grid__inner slider-grid__inner_mod-b"> <img class="img-responsive" src="https://pro-theme.com/html/autozone/assets/media/slider-grid/4.jpg" height="181" width="320" alt="foto"> <span class="slider-grid__name">Audi A6 Saloon</span>
                        <div class="slider-grid__hover"> <span class="slider-grid__price">$28,490</span>
                          <ul class="slider-grid__info list-unstyled">
                            <li><i class="icon icon-speedometer"></i>12,000</li>
                            <li><i class="icon icon-paper-plane"></i>2016</li>
        ...
        <div class="container">
          <div class="row">
            <div class="col-xs-12">
              ...
              <script src="https://pro-theme.com/html/autozone/assets/plugins/rendro-easy-pie-chart/dist/jquery.easypiechart.min.js"></script>
          ...
          <div class="col-xs-12">
            ...
            <ul class="list-brands list-inline">
              <li class="list-brands__item">
                <div class="list-brands__inner"><img class="list-brands__img img-responsive" src="https://pro-theme.com/html/autozone/assets/media/brands/brand-8.jpg" height="57" width="250" alt="Brand"></div>
              </li>
              <li class="list-brands__item">
                <div class="list-brands__inner"><img class="list-brands__img img-responsive" src="https://pro-theme.com/html/autozone/assets/media/brands/brand-4.jpg" height="57" width="250" alt="Brand"></div>
              </li>
              <li class="list-brands__item">
                <div class="list-brands__inner"><img class="list-brands__img img-responsive" src="https://pro-theme.com/html/autozone/assets/media/brands/brand-7.jpg" height="57" width="250" alt="Brand"></div>
              </li>
              <li class="list-brands__item">
                <div class="list-brands__inner"><img class="list-brands__img img-responsive" src="https://pro-theme.com/html/autozone/assets/media/brands/brand-1.jpg" height="57" width="250" alt="Brand"></div>
              </li>
              <li class="list-brands__item">
                <div class="list-brands__inner"><img class="list-brands__img img-responsive" src="https://pro-theme.com/html/autozone/assets/media/brands/brand-5.jpg" height="57" width="250" alt="Brand"></div>
              </li>
            </ul>
          </div>
          <!-- end col --> 
        ...
        <div class="col-xs-12">
          ...
          <ul class="list-staff list-unstyled">
            <li class="list-staff__item clearfix">
              <div class="list-staff__media"> <img class="img-responsive" src="https://pro-theme.com/html/autozone/assets/media/staff/1.jpg" height="280" width="280" alt="foto">
            ...
            <li class="list-staff__item clearfix">
              <div class="list-staff__media"> <img class="img-responsive" src="https://pro-theme.com/html/autozone/assets/media/staff/3.jpg" height="280" width="280" alt="foto">
                <ul class="list-staff__social list-inline">
                  <li><a class="icon fa fa-facebook" href="javascript:void(0);"></a></li>
                  <li><a class="icon fa fa-twitter" href="javascript:void(0);"></a></li>
                  <li><a class="icon fa fa-google-plus" href="javascript:void(0);"></a></li>
            ...
            <li class="list-staff__item clearfix">
              <div class="list-staff__media"> <img class="img-responsive" src="https://pro-theme.com/html/autozone/assets/media/staff/2.jpg" height="280" width="280" alt="foto">
                <ul class="list-staff__social list-inline">
                  <li><a class="icon fa fa-facebook" href="javascript:void(0);"></a></li>
                  <li><a class="icon fa fa-twitter" href="javascript:void(0);"></a></li>
                  <li><a class="icon fa fa-google-plus" href="javascript:void(0);"></a></li>
            ...
            <li class="list-staff__item clearfix">
              <div class="list-staff__media"> <img class="img-responsive" src="https://pro-theme.com/html/autozone/assets/media/staff/4.jpg" height="280" width="280" alt="foto">
                <ul class="list-staff__social list-inline">
                  <li><a class="icon fa fa-facebook" href="javascript:void(0);"></a></li>
                  <li><a class="icon fa fa-twitter" href="javascript:void(0);"></a></li>
                  <li><a class="icon fa fa-google-plus" href="javascript:void(0);"></a></li>
          ...
          <div class="row">
            <div class="col-xs-12">
              ...
              <div class="slider-gallery owl-carousel owl-theme owl-theme_mod-a enable-owl-carousel"
                                                      ...
                                                      data-navigation="false"
                                                      data-stop-on-hover="true">
                <div class="slider-gallery__item"> <a class="slider-gallery__link" href="https://pro-theme.com/html/autozone/assets/media/slider-gallery/1.jpg" rel="prettyPhoto"> <img class="" src="https://pro-theme.com/html/autozone/assets/media/slider-gallery/1.jpg" height="177" width="280" alt="foto">
                  <div class="slider-gallery__hover"> <i class="icon icon-magnifier-add"></i>
                    <div class="slider-gallery__title">AUDI ABT S6</div>
                  </div>
                  </a> </div>
                <div class="slider-gallery__item"> <a class="slider-gallery__link" href="https://pro-theme.com/html/autozone/assets/media/slider-gallery/2.jpg" rel="prettyPhoto"> <img class="img-responsive" src="https://pro-theme.com/html/autozone/assets/media/slider-gallery/2.jpg" height="177" width="280" alt="foto">
                  <div class="slider-gallery__hover"> <i class="icon icon-magnifier-add"></i>
                    <div class="slider-gallery__title">AUDI ABT S6</div>
                  </div>
                  </a> </div>
                <div class="slider-gallery__item"> <a class="slider-gallery__link" href="https://pro-theme.com/html/autozone/assets/media/slider-gallery/3.jpg" rel="prettyPhoto"> <img class="img-responsive" src="https://pro-theme.com/html/autozone/assets/media/slider-gallery/3.jpg" height="177" width="280" alt="foto">
                  <div class="slider-gallery__hover"> <i class="icon icon-magnifier-add"></i>
                    <div class="slider-gallery__title">AUDI ABT S6</div>
                  </div>
                  </a> </div>
                <div class="slider-gallery__item"> <a class="slider-gallery__link" href="https://www.youtube.com/watch?v=neS5h_VSvb8" rel="prettyPhoto"> <img class="img-responsive" src="https://pro-theme.com/html/autozone/assets/media/slider-gallery/4.jpg" height="177" width="280" alt="foto"> <i class="icon icon_video-link icon-control-play"></i>
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <article class="post post_mod-a clearfix">
            <div class="entry-media"> <a href="https://pro-theme.com/html/autozone/assets/media/posts/470x280/1.jpg" rel="prettyPhoto"> <img class="img-responsive" src="https://pro-theme.com/html/autozone/assets/media/posts/470x280/1.jpg" width="470" height="280" alt="Foto"/>
          ...
          <article class="post post_mod-a clearfix">
            <div class="entry-media"> <a href="https://pro-theme.com/html/autozone/assets/media/posts/470x280/2.jpg" rel="prettyPhoto"> <img class="img-responsive" src="https://pro-theme.com/html/autozone/assets/media/posts/470x280/2.jpg" width="470" height="280" alt="Foto"/>
              <div class="post-hover helper"><i class="icon icon-magnifier-add"></i></div>
              </a> </div>
            <div class="entry-main entry-main_mod-a">
              <div class="entry-main__inner entry-main__inner_mod-a">
          ...
          <article class="post post_mod-a clearfix">
            <div class="entry-media"> <a href="https://pro-theme.com/html/autozone/assets/media/posts/470x280/3.jpg" rel="prettyPhoto"> <img class="img-responsive" src="https://pro-theme.com/html/autozone/assets/media/posts/470x280/3.jpg" width="470" height="280" alt="Foto"/>
              <div class="post-hover helper"><i class="icon icon-magnifier-add"></i></div>
              </a> </div>
            <div class="entry-main entry-main_mod-a">
              <div class="entry-main__inner entry-main__inner_mod-a">
            ...
            <div class="col-xs-12">
              ...
              <div class="slider-reviews owl-carousel owl-theme owl-theme_mod-a enable-owl-carousel"
                ...
                <div class="reviews">
                  ...
                  <div class="reviews__img"><img class="img-responsive" src="https://pro-theme.com/html/autozone/assets/media/avatar_reviews/1.jpg" height="55" width="55" alt="avatar"></div>
                ...
                <div class="reviews">
                  ...
                  <div class="reviews__img"><img class="img-responsive" src="https://pro-theme.com/html/autozone/assets/media/avatar_reviews/2.jpg" height="55" width="55" alt="avatar"></div>
                  <div class="reviews__inner">
                ...
                <div class="reviews">
                  ...
                  <div class="reviews__img"><img class="img-responsive" src="https://pro-theme.com/html/autozone/assets/media/avatar_reviews/3.jpg" height="55" width="55" alt="avatar"></div>
                  <div class="reviews__inner">
  ...
  <section class="section_map section-bg-2 wow bounceInUp" data-wow-duration="2s">
    ...
    <!-- end container -->
    <div class="map"><img class="img-responsive" src="https://pro-theme.com/html/autozone/assets/img/map.jpg" height="520" width="1600" alt="map"></div>
    <div class="container text-center">
      ...
      <div class="row">
        <div class="col-sm-10 col-sm-offset-1">
          <form class="form-contact" action="https://pro-theme.com/html/autozone/post">
            <div class="row">
              <div class="col-sm-6">
